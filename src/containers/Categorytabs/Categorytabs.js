        ...
        return (
            <>
                ...
                this.state.categories.map(category=>
                    <div key={category.id}>
                        <Button id="toggle-check"
                        className='text-secondary text-center btn-tabs'
                        onClick={(e)=>this.filterProducts(e,category.id)}
                        key={category.id} variant="link" href={`/product/${category.id}`}>{category.name}
                        </Button>
                        <br/>
                    </div>
